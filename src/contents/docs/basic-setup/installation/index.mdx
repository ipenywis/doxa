...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fdoxa-docs%2Fdoxa&project-name=doxa-docs&repository-name=doxa-docs)
...
```bash
git clone https://github.com/doxa-docs/doxa.git
```
